...
Setting up our application file/folder structure in a conventional way for Redux.
Downloading and installing the necessary dependencies to use Redux along with React.
The pieces of the Redux puzzle and how they work with the React workflow.
Folder Structure  
